...
echo ""
echo "A hosted default relay is resolved automatically when one is configured;"
echo "otherwise share a full invite (code + relay in one token) or self-host."
echo ""
...
echo ""
echo "Self-host a relay:  set MAGPIE_RELAY_URL=ws://<your-host>:8787"
echo "  (run one with: magpie-relay)"
echo ""
